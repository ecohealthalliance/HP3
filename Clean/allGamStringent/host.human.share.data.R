...
## Limit to Hi Quality detection method
...
x = read.csv("~/HP3.PRH/March2016nshared/v41dataKJO/phylo/HP3-cytb_PDmatrix-12Mar2016.csv",
             as.is=T, row.names = 1)
dcb = data.frame(hHostNameFinal = row.names(x), 
                 PdHoSa.cbCst = x$Homo_sapiens )

x = read.csv("~/HP3.PRH/March2016nshared/v41dataKJO/phylo/HP3-ST_PDmatrix-12Mar2016.csv",
             as.is=T, row.names = 1)
