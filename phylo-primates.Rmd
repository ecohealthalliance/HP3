...
plot(allz_gam, select = 9, residuals = TRUE, ylab = "Strength of Effect", xlab = NULL)
title("Best Model")
mtext("AIC = 1517.584")

plot(primate_re, select = 10, residuals = TRUE)
title("Primates Random Effect ")
mtext("AIC = 1517.584")

plot(primate_fe, select = 9, residuals = TRUE)
title("Primates Fixed Effect")
mtext("AIC = 1519.172")
```

__The variable Order Primates, when added to the best model as a random effect, has effective degrees of freedom of 0.0001 and is correctly removed from the   
